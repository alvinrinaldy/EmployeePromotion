sap.ui.define([	
	...
	return BaseController.extend("ZAL.Promosi.controller.SelectEmployeePromotion", {
		...
		// 			"ZAL.Promosi.view.ValueHelpDialog.ValueHelpSelectEmployee",
		// 			this
		// 		);
		...
		handleValueHelpSelectEmployee : function (oController) {
			...
			this._oValueHelpDialog = sap.ui.xmlfragment("ZAL.Promosi.view.ValueHelpDialog.SelectEmployee", this);
